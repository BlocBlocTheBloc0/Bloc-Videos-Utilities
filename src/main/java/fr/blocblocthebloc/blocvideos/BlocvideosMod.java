 ...
 *
 */
package fr.blocblocthebloc.blocvideos;
...
public class BlocvideosMod {
	public static final Logger LOGGER = LogManager.getLogger(BlocvideosMod.class);
	public static final String MODID = "blocvideos";
	...
	public BlocvideosMod() {
		...
		BlocvideosModTabs.REGISTRY.register(bus);
